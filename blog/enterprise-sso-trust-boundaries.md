...
@image[Initial Update from F5 SIRT](assets/enterprise-sso-trust-boundaries/F5-SIRT.png)
...
@image[Screenshot of the github repo on official Docker-Nginx](assets/enterprise-sso-trust-boundaries/remediation-github.png)
